...
//Значения автокорреляционной функции всегда < |0.1|, лишь изредка приближаясь к пороговому значению, а мат. ожидание колеблется в пределах +-0.017 от ожидаемого.
//На основании данного наблюдения, реализацию метода Math.random() можно счесть положительной.
    ...
    public static void main(String[] args) {
        ...
        for(double i = 0; i < (double)(countsSorted.size() / scale); i += 0.001) {
            ...
            for(int j = 0; j < scale - 1; j++) {
                if (round(countsSorted.get((int)(i * scale)), 6) == round(countsSorted.get(j+1), 6)) {
                    count++;
                }
            }
